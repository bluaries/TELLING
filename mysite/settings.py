...
DATABASES = {
    'default': {
        ...
        'PORT': 5432,
        'USER': 'odotavrnhxwfxd',
        'PASSWORD': '53794a92d445cb9556d8a0f2f4574f8dedf88d84a046d97da67ff360fff11ce0'
    }
}
...
if 'HEROKU' in os.environ:
    ...
    STATIC_URL = '/static/'
    STATICFILES_DIRS = (
    BASE_DIR + '/TELLING/static/' ,
)

STATICFILES_DIRS = [os.path.join(BASE_DIR, 'TELLING', 'static'), ]
...
OAUTH_LOGIN_URL = '/auth/login/google-oauth2/'
...
SOCIAL_AUTH_FACEBOOK_KEY = "351896069246021"
SOCIAL_AUTH_FACEBOOK_SECRET = "f082e735232d1b4ce4c674abd61882e4"
